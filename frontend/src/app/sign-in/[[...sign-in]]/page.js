            ...
            <div style={{ 
                ...
                <div style={{ position: "relative", zIndex: 10, maxWidth: "500px", margin: "0 auto" }}>
                    ...
                    <h1 style={{ fontSize: "42px", fontWeight: "700", color: "var(--text-primary)", lineHeight: "1.2", marginBottom: "20px" }}>
                        Intelligent Architecture Risk Analysis
                    </h1>
                    <p style={{ fontSize: "18px", color: "var(--text-secondary)", lineHeight: "1.6", marginBottom: "40px" }}>
                        Design, stress-test, and analyze your distributed systems before you build them. Discover single points of failure instantly.
                    </p>

                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                        <div style={{ display: "flex", alignItems: "center" }}>
                            <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "var(--bg-secondary)", border: "2px solid var(--bg-primary)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 3 }}><span style={{ fontSize: "10px" }}>👨‍💻</span></div>
                            ...
                            <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "var(--bg-secondary)", border: "2px solid var(--bg-primary)", display: "flex", alignItems: "center", justifyContent: "center", marginLeft: "-10px", zIndex: 1 }}><span style={{ fontSize: "10px" }}>⚡</span></div>
                        </div>
                        <span style={{ fontSize: "14px", color: "var(--text-muted)" }}>Join thousands of system architects</span>
                    </div>
                </div>
            </div>
